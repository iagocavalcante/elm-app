...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Switch') {
			return (model.name === 'Rémy') ? _Utils_update(
				model,
				{name: 'Séverine'}) : _Utils_update(
				model,
				{name: 'Rémy'});
		} else {
			var newName = msg.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onClick(author$project$Main$Switch)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onInput(author$project$Main$NewName),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Switch":[],"NewName":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));